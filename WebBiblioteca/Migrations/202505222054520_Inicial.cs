namespace WebBiblioteca.Migrations
{
    ...
    public partial class Inicial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Autor = c.String(nullable: false, maxLength: 200),
                        Anyo = c.Int(nullable: false),
                        ISBN = c.String(),
                        Stock = c.Int(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Prestamoes", "UsuarioId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Prestamoes", "LibroId", "dbo.Libroes");
            ...
            DropIndex("dbo.Prestamoes", new[] { "UsuarioId" });
            DropIndex("dbo.Prestamoes", new[] { "LibroId" });
